    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' }, // Prefetch DNS para mejorar rendimiento
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' }, // Seguridad adicional
        ],
      },
      {
        source: '/fonts/(.*)',
