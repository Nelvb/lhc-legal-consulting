 ...
 * con paginación profesional y diseño responsive. Header animado con gradiente LHC
...
const BlogPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen">
            {/* Header animado con gradiente LHC */}
            <div
                ref={headerRef}
                className={`
          w-full py-20 lg:py-32 px-6 relative overflow-hidden
